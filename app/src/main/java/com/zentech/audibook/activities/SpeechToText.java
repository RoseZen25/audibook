...
public class SpeechToText extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageBack = findViewById(R.id.imageBackSpeech);
        ...
        ImageView imageCopy = findViewById(R.id.imageCopy);
        imageCopy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(SpeechToText.this, "Copied.", Toast.LENGTH_SHORT).show();
            }
        });
